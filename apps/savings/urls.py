...
urlpatterns = [
    ...
    path("dashboard/", views.financial_services_dashboard, name="financial_services_dashboard"),
    ...
    path("client/savings/", views.client_savings_dashboard, name="client_savings_dashboard"),
    path("client/savings/statement/", views.client_savings_statement, name="client_savings_statement"),
    path("client/savings/request/", views.client_savings_request, name="client_savings_request"),
    path(
    ...
    path("client/savings/deposit/", views.client_savings_deposit_request, name="client_savings_deposit_request"),
    path(
