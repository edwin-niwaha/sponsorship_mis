...
urlpatterns = [
    ...
    path("terminate-child-sponsorship/<int:child_id>/", views.terminate_child_sponsorship, 
    ...
    path('terminate-sponsorship/<int:sponsorship_id>/', views.terminate_staff_sponsorship, 
         name='terminate_staff_sponsorship'),
    path('sponsorship/<int:sponsorship_id>/edit/', views.edit_staff_sponsorship, name='edit_staff_sponsorship'),
]
