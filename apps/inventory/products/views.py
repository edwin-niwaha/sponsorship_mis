...
def inventory_add_view(request):
    context = {
        ...
        "form": InventoryForm() if request.method != "POST" else None,
    }
    ...
    # If not POST or if the form is invalid, include the form in the context
    context["form"] = form if form else context["form"]
