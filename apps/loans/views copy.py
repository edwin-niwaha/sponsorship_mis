...
#     # Total amount that should have been paid by today
#     total_due_by_today = (monthly_installment * installments_due_by_now).quantize(
#         Decimal("0.01"), rounding=ROUND_HALF_UP
#     )

#     # --- Pass 2: find the first installment not yet covered by cumulative payments ---
#     first_unpaid_due_date = None
#     for installment_no in range(1, installments_due_by_now + 1):
#         due_date = disbursement_date + relativedelta(months=installment_no)
#         cumulative_due = (monthly_installment * installment_no).quantize(
#             Decimal("0.01"), rounding=ROUND_HALF_UP
#         )
