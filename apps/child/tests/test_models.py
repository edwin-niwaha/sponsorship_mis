...
#             score=0,
#             co_curricular_activity="Football",
...
#     def test_default_values(self):
#         # Test default values
#         self.assertEqual(self.child_progress.score, 0)  # Default value for score
#         self.assertIsNone(
#             self.child_progress.co_curricular_activity
#         )  # Default value for optional fields
#         self.assertIsNone(
#             self.child_progress.responsibility_at_school
#         )  # Default value for optional fields
#         self.assertIsNone(
#             self.child_progress.responsibility_at_home
#         )  # Default value for optional fields
#         self.assertIsNone(
#             self.child_progress.notes
#         )  # Default value for optional fields
